...
function App() {
  ...
  const testWhatsApp = async () => {
    ...
    try {
      const response = await api.post<{ success: boolean; messageId?: string; error?: string }>("/whatsapp/test", {
        message: "Test message from Laos Shop! " + new Date().toLocaleString(),
      });
      console.log('WhatsApp test message response:', response);
      if (response.success) {
        ...
        <div className="header-container">
          ...
          <div className="header-actions">
            ...
            >
              ...
              {whatsappTesting ? "Sending..." : "Test WA"}
            </button>
